...
# installed.
TK_PREFIX='/Users/apple/Downloads/videosummarizer/venv'

# Top-level directory in which Tk's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/Users/apple/Downloads/videosummarizer/venv'
...
# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/Users/apple/Downloads/videosummarizer/venv/lib -ltk8.6'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I/Users/apple/Downloads/videosummarizer/venv/include'
...
# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/Users/apple/Downloads/videosummarizer/venv/lib -ltkstub8.6'
...
TK_STUB_LIB_PATH='/Users/apple/Downloads/videosummarizer/venv/lib/libtkstub8.6.a'
